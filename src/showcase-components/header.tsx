...
export const Header = ({ onToggleSidebar, sidebarOpen }: IHeaderProps): HTMLElement => {
  ...
  return (
    <header className={headerClasses} style={{ height: 'var(--header-height)' }}>
      <div className="flex items-center justify-between h-full px-md">
        ...
        <div className="flex items-center gap-md">
          ...
          <div className="flex items-center gap-sm">
            {/* Logo with gradient */}
            <div
              className="gradient-primary-secondary shadow-md hover-lift"
              style={{
                width: '32px',
                height: '32px',
            ...
            <div>
              <h1 className="text-xl font-bold text-text m-0">Pulsar UI</h1>
              <p className="text-xs text-text-muted m-0">Component Library</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-md">
          <a
            ...
            className="text-text-muted hover:text-text transition-colors focus-ring rounded-md p-2 hover-scale"
