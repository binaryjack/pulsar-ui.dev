...
const textareaDefaultConfig = new ComponentConfigBuilder('primary')
  .size('md')
  .rounded('md')
  .build();
...
const textareaDefaultStyling = new ComponentStylingBuilder()
  .base('block border font-medium focus:outline-none resize-y touch-target')
...
export const Textarea = ({
  ...
  const className = cn(
    ...
    config.disabled
      ? styling.disabled
      : 'readOnly' in rest && rest.readOnly
        ? styling.readOnly
        : styling.background,
