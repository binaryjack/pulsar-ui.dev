...
export { default as DatePickerV3, default } from './date-picker.syn';

// Export types and enums
export type { DatePickerGridModeType, DatePickerSelectionModeType } from './core/date-picker.types';
export type { DatePickerProps } from './date-picker.syn';
...
export { Toggleable } from './toggleable/toggleable.syn';
