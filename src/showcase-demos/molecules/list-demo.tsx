...
export const ListDemo = (): HTMLElement => {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">List</h1>
    ...
    In progress
      ...
      <DemoSection title="Spacing Options" description="Control spacing between items">
        <Stack direction="vertical" spacing="xl">
          <div>
            <p className="text-sm font-medium mb-2">Small spacing:</p>
            <List spacing="sm">
          ...
          <div>
            <p className="text-sm font-medium mb-2">Large spacing:</p>
            <List spacing="lg">
              <ListItem>Item 1</ListItem>
              <ListItem>Item 2</ListItem>
              <ListItem>Item 3</ListItem>
