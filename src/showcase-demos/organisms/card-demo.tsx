...
export const CardDemo = (): HTMLElement => {
  return (
    <div class="space-y-8">
      <div>
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Card</h1>
  ...
  <p>Card content...</p>
      ...
      <DemoSection title="Card with Footer" description="Card with footer section">
        ...
        >
          ...
          <p class="text-gray-600 mb-4">Update your preferences and settings here.</p>
          <div class="space-y-2">
        ...
        <Card
          header={
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-sm text-gray-500">Premium subscription plan</p>
              </div>
          ...
          footer={
            <div class="flex justify-between items-center">
              <span class="text-sm text-gray-500">Last updated: Jan 29, 2026</span>
          ...
          <div class="space-y-4">
            <div>
              <p class="text-2xl font-bold text-gray-900">
                $29.99<span class="text-sm font-normal text-gray-500">/month</span>
              </p>
            </div>
            <ul class="space-y-2">
      ...
      <DemoSection title="Shadow Variants" description="Different elevation levels">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card config={new ComponentConfigBuilder('primary').shadow('sm').build()}>
            <h4 class="font-semibold mb-2">Small Shadow</h4>
            <p class="text-sm text-gray-600">Subtle elevation</p>
          </Card>
          <Card config={new ComponentConfigBuilder('primary').shadow('md').build()}>
            <h4 class="font-semibold mb-2">Medium Shadow</h4>
            <p class="text-sm text-gray-600">Default elevation</p>
          </Card>
          <Card config={new ComponentConfigBuilder('primary').shadow('lg').build()}>
            <h4 class="font-semibold mb-2">Large Shadow</h4>
            <p class="text-sm text-gray-600">High elevation</p>
          </Card>
        </div>
        <CodeBlock
      ...
      <DemoSection title="Rounded Variants" description="Different border radius options">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card config={new ComponentConfigBuilder('primary').rounded('md').build()}>
            <h4 class="font-semibold mb-2">Medium Rounded</h4>
            <p class="text-sm text-gray-600">Slightly rounded corners</p>
          </Card>
          <Card config={new ComponentConfigBuilder('primary').rounded('lg').build()}>
            <h4 class="font-semibold mb-2">Large Rounded</h4>
            <p class="text-sm text-gray-600">More rounded corners</p>
          </Card>
          <Card config={new ComponentConfigBuilder('primary').rounded('xl').build()}>
            <h4 class="font-semibold mb-2">Extra Large</h4>
            <p class="text-sm text-gray-600">Very rounded corners</p>
          </Card>
        </div>
        <CodeBlock
